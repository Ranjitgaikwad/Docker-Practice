...
2. **Data Integrity:**
   ...
   - **Attempting to create a new file (`Gaikwad.html`) will fail due to READ-ONLY permissions.**

   **Error Output:**

   ```
   cp: can't create 'Gaikwad.html': Read-only file system
   ```
...
3. **Accessing the Application:**
   ...
   - **Attempting to access `http://localhost:8093/Gaikwad.html` will result in a 404 error**, confirming that the file was not created.
...
2. **Data Integrity:**
   - The `static-content` directory's contents are accessible within the container.
   - **Attempting to create a new file (`Gaikwad2.html`) will fail due to READ-ONLY permissions.**

   **Error Output:**

   ```
   cp: can't create 'Gaikwad2.html': Read-only file system
   ```

3. **Accessing the Application:**
   - Open a browser and navigate to `http://localhost:8094` to view the static content.
   - **Attempting to access `http://localhost:8094/Gaikwad2.html` will result in a 404 error**, confirming that the file was not created.
