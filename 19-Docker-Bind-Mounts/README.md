...
2. **Data Integrity:**
   ...
   - Creating a new file (`Ranjit.html`) demonstrates read-write access.

3. **Accessing the Application:**
   - Open a browser and navigate to `http://localhost:8091` to view the static content.
   - Access `http://localhost:8091/Ranjit.html` to verify the newly created file.
...
2. **Data Integrity:**
   - The `static-content` directory's contents are accessible within the container.
   - Creating a new file (`Ranjit2.html`) demonstrates read-write access.

3. **Accessing the Application:**
   - Open a browser and navigate to `http://localhost:8092` to view the static content.
   - Access `http://localhost:8092/Ranjit2.html` to verify the newly created file.
...
- You should find the files `Ranjit.html` and `Ranjit2.html` present.
  - **`Ranjit.html`**: Created by `bind-demo1`.
  - **`Ranjit2.html`**: Created by `bind-demo2`.
