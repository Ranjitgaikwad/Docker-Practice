...
description: "Understand the differences between ARG and ENV instructions in Dockerfiles, 
---
...
<html>
  <body style="background-color: rgb(152, 202, 134);">
    <h1>Welcome to Ranjit Gaikwad - ARG (Build-time) and ENV (Runtime) Variables</h1>
...
- Understand the differences between `ARG` and `ENV` instructions in Dockerfiles.
