...
# Sample Output
ranjit-mini2:healthchecks-demo ranjit$ docker compose ps
...
ums-stack-app-ums-1   ghcr.io/ranjitgaikwad/usermgmt-webapp-v6:latest   "catalina.sh run"        app-ums     39 seconds ago   Up 38 seconds (healthy)   0.0.0.0:63848->8080/tcp
ranjit-mini2:healthchecks-demo ranjit$ 
```
