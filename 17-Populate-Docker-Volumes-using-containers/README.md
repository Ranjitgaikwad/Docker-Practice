...
http://localhost:8093/Ranjit.html

# Access the New File via curl
curl http://localhost:8093/Ranjit.html
```

**Observation:**

- The file `Ranjit.html` is successfully created and accessible, indicating that the volume is mounted with read-write permissions.
...
# Access the Application in Browser
http://localhost:8095/Ranjit.html
```
